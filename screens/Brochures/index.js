...
const brochuresHeadText =
  'Enter your e-mail address and select from the list below and hit send:';
...
class Brochures extends Component {
  ...
  isChecked(entry) {
    return (
      this.state.checkedComss && this.state.checkedComss.includes(entry.value);
    );
  }
  ...
  render() {
    ...
    return [
        ...
        {brochures ? (
          ...
          <Loading displayText={''} visible={!brochures} />
        )}
      </View>,
    ];
  }
